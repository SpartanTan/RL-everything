...
v_left_set = np.linspace(0.1, 1.0, 10)  # Range of left wheel speeds rad/s
...
def sample_paths_diff_drive_robot(v_left_set, v_right_set, initial_state, dt, N, ref_path, obstacles, goal, atr:ATR_RK4):
    PATHS = []
    approach_goal = False
